...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "about.p2t": "One coordination centre",
      ...
      "about.p3b": "The approach covers more than legal coordination: risk management, the security of assets and the reputational aspects that carry weight in cross-border matters.",
    ...
    ru: {
      ...
      "about.p2t": "Единый координационный центр",
      ...
      "about.p3b": "Подход включает не только юридическую координацию, но и управление рисками, вопросы безопасности активов и репутационные аспекты, которые имеют значение в трансграничных делах.",
